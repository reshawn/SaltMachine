...
public class unsaltActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_unsalt);
    ...
    protected void onStart() {
        ...
        ValueEventListener countListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ValueEventListener phraseListener = new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()) {
                            ...
                            TextView resText = (TextView) findViewById(R.id.resultText2);
                ...
                phraseRef.child("sugar").child(key).addListenerForSingleValueEvent(phraseListener);
        ...
        countRef.child("sugar_counter").addListenerForSingleValueEvent(countListener);
    }
